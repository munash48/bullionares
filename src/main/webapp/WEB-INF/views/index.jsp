    ...
    <nav class="navbar navbar-fixed-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="header"><a>Total Advert cash: <b>${totalCash}</b>/=</a></li>
      <li class="dropdown tasks-menu"><a href="javascript:void(0);" id ="chart1"> <i
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="/perform-logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="javascript:void(0);" id ="chart" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
