...
public class DisplayWrittenReco {
	private int rUid;
	...
	public DisplayWrittenReco() {
		super();
		// TODO Auto-generated constructor stub
	}

	public DisplayWrittenReco(String fullName, String rImageLink, Date rCreateDate, String rDescription, int rUid) {
		super();
